...
public class AllAppUsersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        usersRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot datasnapshot) {
                ...
                allInvestorsCount.setText("Total App Users: " +noOfInvestors);
            }
    ...
    public void onStart() {
        ...
        FirebaseRecyclerAdapter<User, MyViewHolder> adapter = new FirebaseRecyclerAdapter<User, AllAppUsersActivity.MyViewHolder>(options) {
            @Override
            protected void onBindViewHolder(@NonNull AllAppUsersActivity.MyViewHolder holder, @SuppressLint("RecyclerView") final int position, @NonNull User model) {

                holder.userName.setText(model.getFullname());
                holder.userEmail.setText(model.getEmail());
                holder.userTypeBtn.setText(model.getType());
                Glide.with(getApplicationContext()).load(model.getProfileimageurl()).into(holder.profileImage);
